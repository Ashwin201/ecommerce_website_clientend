        ...
        <div className=" grid col-span-3 md:col-span-2 lg:rid-cols-4 gap-5 md:gap-10 mt-10   place-items-center  ">
          <div className=" flex flex-col gap-3 text-center  items-center justify-center col-span-3 md:col-span-2 lg:col-span-1 ">
            ...
            <p className=" text-gray-800  dark:text-gray-400    font-medium text-base">
              I&apos;m Ashmin Sharma, a dedicated web developer and UI designer
              with a strong commitment to creating visually appealing,
              functional, and responsive designs. I possess a profound passion
