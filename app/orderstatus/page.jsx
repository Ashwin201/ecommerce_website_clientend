  ...
  return session_id ? (
    ...
    <>
      <div className=" flex flex-col justify-center items-center w-full min-h-[74vh]">
        ...
        <div className="mt-6">
          <h1 className=" font-bold text-2xl sm:text-3xl text-center bg-gradient-to-r from-slate-700 via-purple-900 to-slate-700 inline-block text-transparent bg-clip-text mb-6">
            Please order something before accessing this page.
          </h1>
        </div>
        <Link
          href={"/products"}
